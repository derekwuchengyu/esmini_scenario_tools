...
paramdec.add_parameter(xosc.Parameter(
    ego_param_name, xosc.ParameterType.double, "10"))
...
init.add_init_action(egoname, xosc.TeleportAction(
    xosc.LanePosition(25, 0, -3, 0)))
init.add_init_action(redname, xosc.AbsoluteSpeedAction(
    target_param_name, step_time))
init.add_init_action(redname, xosc.TeleportAction(
    xosc.LanePosition(15, 0, -2, 0)))
